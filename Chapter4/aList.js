...
// A common data structure is the list (not to be confused with arrays). A list is a nested
...
// A diagram showing the memory structure of a linked list. There are 3 cells,
// each with a value field holding a number, and a 'rest' field with an arrow
// to the rest of the list. The first cell's arrow points at the second cell,
// the second cell's arrow at the last cell, and the last cell's 'rest' field holds null.
...
// produces an array from a list. Add the helper functions prepend, which takes an element
